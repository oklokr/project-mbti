...
const mbti = [
    ...
    },
    {
        name: 'ENFJ' ,
        title: '다정한 긍정의 아이콘형',
        text: '사람을 좋아하고 헌신적이며, 따뜻한 마늘통닭처럼 많은 사람들이 당신을 좋아해요.많은 사람들에게 따뜻한 인상을 주고, 책임감 있고, 열정적인 성격입니다. 탈없고 긍정적이어서 성격이 좋지만, 거절을 못해서 계획이 틀어지는 일도 꽤나 많아요. 행동력을 잘 발휘한다면 원하는 목표에 한 발 더 가까워 질 수 있을 거에요!',
